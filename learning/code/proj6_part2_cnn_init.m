...
% good idea to add one or both of them back in between fc6 (index 16) and fc7 (index 18) and
% between fc7 and fc8 (index 20).
...
net.layers{end-1} = struct('type', 'conv', ...
                           'weights', {{(1/100)*randn(1,1,4096,15, 'single'), zeros(1, 15, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'name', 'myfc8') ;
