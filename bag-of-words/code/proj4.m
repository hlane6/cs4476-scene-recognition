...
% run('~/Documents/programming/matlab/vlfeat/toolbox/vl_setup')
...
switch lower(FEATURE)    
    ...
    case 'bag of sift'
        ...
        if ~exist('train_feat.mat', 'file')
            train_image_feats = get_bags_of_sifts(train_image_paths);
            save('train_feat.mat', 'train_image_feats')
        else
            load('train_feat.mat')
        end
        
        if ~exist('test_feat.mat', 'file')
            test_image_feats  = get_bags_of_sifts(test_image_paths);
            save('test_feat.mat', 'test_image_feats')
        else
            load('test_feat.mat')
        end
